---
layout: page
title: <i class="fas fa-user-shield fa-2x"></i>  Espace bureau
hide: true
---
<font size="6">
<center>
...
Les [réponses](https://docs.google.com/forms/d/1qxJ9jkGC-pUyV14EXjzay8483VbvkJmBMysq61KpiOE/edit#responses) à consulter pendant les réunions 
<center> <iframe
...
<center>
<iframe src="/assets/dossier.pdf" height="800" width="45%"></iframe>
<iframe src="/assets/plaquette.pdf" height="800" width="45%"></iframe>
</center>
...
countdownManager = {
	// Configuration
	targetTime: new Date('Month day hour:min:sec year'), // Date cible du compte à rebours (00:00:00)
